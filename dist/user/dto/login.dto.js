...
let LoginInput = class LoginInput extends graphql_1.PickType(user_entity_1.User, ['username', 'password']) {
};
LoginInput = __decorate([
    graphql_1.InputType()
], LoginInput);
exports.LoginInput = LoginInput;
let LoginOutput = class LoginOutput extends common_dto_1.CoreOutput {
};
__decorate([
